...
//	}
	...
	public void Initialize()
	{
		...
		if(_Target != null)
		{
			_State = _Target.GetComponent<Animation>()[_StateName];
			_State.speed = _Speed;
	...
	{
		get { return _Target.GetComponent<Animation>().IsPlaying(_State.name);}
	}

	public bool IsPlayingButNotThis
	{
		get { return _Target.GetComponent<Animation>().isPlaying && !IsPlaying;}
	}
	...
	{
		_Target.GetComponent<Animation>().CrossFade(_State.name, _FadeLength);
	}
	...
	public void EndAnimationEffect()
	{
		...
		{
			_Target.GetComponent<Animation>().Stop();
		}
	}
