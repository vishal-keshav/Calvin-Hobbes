...
//			_id = gameObject.GetInstanceID ().ToString ();
			...
			if (gameObject.GetComponent<Collider>() != null) {
				...
				_width = gameObject.GetComponent<Collider>().bounds.size.z;
				_height = gameObject.GetComponent<Collider>().bounds.size.y;
				_length = gameObject.GetComponent<Collider>().bounds.size.x;
			} else {
			...
			if (gameObject.GetComponent<Rigidbody>() != null) {
				_weight = gameObject.GetComponent<Rigidbody>().mass;
			} else {
				_weight = 0.0f;
			}
